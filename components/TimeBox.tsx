import { timeOver } from "../data/data";
import { useEffect, useState } from "react";

const weddingDate: any = new Date(timeOver);
...
export function TimeBox() {
  ...
  return (
    <section className=" flex flex-col gap-5 text-center  text-vrayi  px-0 ">
      ...
      <div className="">
        {timeLeft.finished ? (
          ...
          <div className="flex justify-center text-6xl font-extralight ">
...
const TimeBoxItem = ({ label, value }: any) => (
  <div className=" text-[32px] px-2 text-center ">
    <h2 className="mt-1 FontArmDecorativeU">{value}</h2>
    <p className="FontArmDecorativeU text-xl">{label}</p>
  </div>
);
